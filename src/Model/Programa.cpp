...
void Programa::inicializarFiguras(){
    ...
    vectorFiguras.push_back(new Triangulo(5.8,6.5,8.3,12.0));
}
...
void Programa::agregarFigura(float ladoA, float ladoB, float ladoC, float altura) {
    vectorFiguras.push_back(new Triangulo(ladoA,ladoB,ladoC,altura));
}
