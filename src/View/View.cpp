...
void View::agregarFigura() {
    int opcion;
    float longitudLado, base, altura, radio, lado, diagonalMenor, diagonalMayor,ladoA,ladoB,ladoC;
    ...
    switch (opcion){
        ...
        case 5:{
            ...
            cin >> ladoC;
            programaObj->agregarFigura(ladoA,ladoB,ladoC,altura);// Importante el casteo para que se llame al metodo correcto
        }
    }
}
